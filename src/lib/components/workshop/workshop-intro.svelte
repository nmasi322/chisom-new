...
<section class="mx-auto max-sm:px-5 sm:max-w-4/5" bind:this={containerElement}>
	...
	>
		...
		My short story
		<a
			style="font-style: italic; color: #ea580c;"
			href="https://kalaharireview.com/ịgbachi-ṅkịtị-6a057dfb11a5">Igbachi Nkiti</a
		>, published in <span style="font-style: italic; color: #000;">The Kalahari Review</span>, was
		...
		and religious structures. <br /> My poem
		<a
			style="font-style: italic; color: #ea580c;"
			href="https://brittlepaper.com/2026/01/have-you-seen-the-news-chisom-winifred-poetry/"
			>“Have You Seen the News?”</a
		>
		in <span style="font-style: italic; color: #000;">Brittle Paper</span> reflects on governance in
		Africa, while my essay in the
		<span style="font-style: italic; color: #000;">Brittle Paper Seasonal Migration Anthology</span>
		explores the journeys of immigrants globally, both on the continent and in diaspora. My short
		story
		<a
			style="font-style: italic; color: #ea580c;"
			href="https://fossewaywriters.com/2025/09/07/flash-fiction-competition-2025-results/"
			>“Children With No Angels”</a
		>
		that won the 2025 Fosseway Writers Flash Fiction Competition shows my engagement with narrative
		experimentation, and two forthcoming stories in the
		<span style="font-style: italic; color: #000;">Favourites</span>
		anthology by St James Writers, expected February 2026, continue this exploration. Across these
		...
		served as Beauty Editor at
		<span style="font-style: italic; color: #000;">Glam Africa Magazine,</span>
		a quarterly print publication with a global readership of over 1.5 million people, largely of
		...
		and sustainability are truthfully answered. <br />
		<br />
