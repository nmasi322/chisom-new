...
export const tutors = [
    {
        ...
        masterclass: {
            ...
            description: "In this masterclass, Roseline Mgbodichinma will guide writers through the practical steps of building a sustainable and visible writing career. Drawing on her experience as a published author, award-winning writer, and mentor, Roseline will explore how to navigate literary opportunities, position your work for maximum impact, and cultivate both creative and professional growth.\n\nParticipants will gain insights on:",
            learningPoints: [
                "Developing a clear authorial identity and voice",
                "Identifying opportunities for publication, residencies, and awards",
                "Networking effectively within literary communities",
                "Balancing creative output with professional advancement",
                "Leveraging your work to achieve global readership and recognition"
            ],
            closingWords: 'This session combines career strategy with mentorship, giving emerging writers actionable tools to take their writing to the next level.'
        }
    },
    {
        img: summer,
    ...
    },
    {
        ...
        url: 'megan-cassells',
        name: "Megan Cassells",
        bio: 'Megan Cassells is an experimental prose and creative nonfiction writer based in Lincolnshire. She is Assistant Editor in Chief of The Lincoln Review and holds an MA in Creative Writing from University of Lincoln, and a BA (Hons) in Film from Anglia Ruskin, Cambridge. She is the recipient of the University of Lincoln’s Outstanding Achievement Award in Creative Writing and has work forthcoming in Vellichor Literary and Issue 7 of The Lincoln Review. She is currently working on her first novel, rooted in Irish history and mythology. She is half Irish and half English and blames this for her exorbitant consumption of tea.',
        masterclass: {
            title: "Publishing in International Journals",
            description: "In this session, Megan Cassells will guide writers through the practical steps of getting their work published in international journals. Drawing on her experience as Assistant Editor in Chief of The Lincoln Review and as a published experimental prose and creative nonfiction writer, Megan will share insider insights into what editors look for, how to prepare strong submissions, and how to navigate the competitive world of global literary publication.\n\nParticipants will learn how to:",
            learningPoints: [
                "Identify suitable international journals for their work",
                "Craft submission materials that stand out",
                "Understand editorial expectations and feedback processes",
                "Build a track record that opens doors for future opportunities",
            ],
            closingWords: 'This session is designed for emerging writers seeking clarity, strategy, and confidence in taking their work to a global audience.'
        }
    },
    {
        img: chisom,
